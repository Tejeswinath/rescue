...
import requests
import pandas as pd
data=pickle.load(open("C:\Users\Tejes\Downloads\Air_quality_pred\data.pkl",'rb'))
model=pickle.load(open("C:/Users/Tejes/Downloads/Air_quality_pred/model.pkl",'rb'))
